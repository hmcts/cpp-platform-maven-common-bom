...
- Updated the imported `cp-maven-common-bom` (`framework-comon-bom.version`) to 25.104.2: postgresql 42.7.13
  ([CVE-2026-42198](https://www.cve.org/CVERecord?id=CVE-2026-42198), [CVE-2026-54291](https://www.cve.org/CVERecord?id=CVE-2026-54291)),
  micrometer 1.16.7 ([CVE-2026-40984](https://www.cve.org/CVERecord?id=CVE-2026-40984), [CVE-2026-40983](https://www.cve.org/CVERecord?id=CVE-2026-40983)),
  log4j 2.25.5 ([CVE-2026-49844](https://www.cve.org/CVERecord?id=CVE-2026-49844)), plexus-utils 3.6.2 ([CVE-2025-67030](https://www.cve.org/CVERecord?id=CVE-2025-67030))
- `netty-bom` 4.1.119.Final → 4.1.138.Final: 61 advisories including critical [CVE-2026-75595](https://www.cve.org/CVERecord?id=CVE-2026-75595) (SNI routing bypass)
- `httpcore5` / `httpcore5-h2` 5.3.6 → 5.4.4: [CVE-2026-54399](https://www.cve.org/CVERecord?id=CVE-2026-54399), [CVE-2026-54428](https://www.cve.org/CVERecord?id=CVE-2026-54428) (no fix on 5.3.x)
